...
<div class="contentAdministrator">
    <div class="formulario">
        <h1>Añadir una nueva tarta</h1>
        <br>
        <form class="row g-3" action="addTarta" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-12">
                ...
                <button class="btn btn-primary" type="submit"><span>Añadir Tarta</span></button>
